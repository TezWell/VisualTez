...
class ToolboxSearch extends Blockly.ToolboxCategory {
    ...
    createDom_() {
        ...
        this.button.className =
            'flex items-center justify-center w-12 font-bold text-black dark:text-white border-b-4 rounded-r-md bg-yellow-500 hover:bg-yellow-400 border-yellow-700 hover:border-yellow-500';
