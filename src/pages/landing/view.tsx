        ...
        <div className="container px-3 mx-auto flex flex-wrap flex-col lg:flex-row items-center justify-evenly">
            <div className="flex flex-col w-full md:w-4/5 lg:w-2/5 justify-center items-center lg:items-start text-center md:text-left">
                ...
                <div className="inline-flex spacing-2">
                    <RouterButton
                        to="/editor"
                        className="h-14 inline-flex items-center px-4 text-sm lg:text-lg bg-black dark:bg-white text-white dark:text-black font-bold rounded-full shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                    >
                        Open Editor
                    </RouterButton>
                    <a
